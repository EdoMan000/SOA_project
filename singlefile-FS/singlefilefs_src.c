...
//to make it compatible with kern 6.5
...
MODULE_DESCRIPTION("SINGLE-FILE-FS. PS:] this module was modified by Edoardo Manenti <manenti000@gmail.com> during the development of a project for Advanced Operating System Exam");
